...
_ctrlButtonPrev ctrlAddEventHandler ["buttonClick",{[-1] call FUNC(onBodycamPrevNextButton)}];
...
_ctrlButtonNext ctrlAddEventHandler ["buttonClick",{[1] call FUNC(onBodycamPrevNextButton)}];
...
[] call FUNC(updateBodycamOverlay);
