...
_tipPos = [_pos, _mainLength + 10, _dir] call BIS_fnc_relPos;
_fin1Pos = [_tipPos, -(_finLength * 1.14), _dir-30] call BIS_fnc_relPos;
_fin2Pos = [_tipPos, -(_finLength * 1.14), _dir+30] call BIS_fnc_relPos;
